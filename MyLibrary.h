...
//Gestione random: 
	...
	{
		cout << "Inserisci valore minimo del random: " << endl;
		cin >> random_min;	
		cout << "Inserisci valore massimo del random: " << endl;
		cin >> random_max;	
	}
...
//Stampa elementi del vettore:
	void stampaVettore(int v[], int n)
	{
		cout << "Stampo il vettore di interi:" << endl;
		for (int i=0; i<n; i++)
	...
	void stampaVettore(float v[], int n)
	{
		cout << "Stampo il vettore di float:" << endl;
		for (int i=0; i<n; i++)
			cout << "\tElemento " << i+1 << ": " << v[i] << endl;
		cout << endl;
	}
